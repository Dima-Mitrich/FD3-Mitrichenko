        ...
        return (
            <tr>
                ...
                <td>
                    {
                        this.state.mode === 'show' ?
                            <button onClick={this.setMode} id='editBtn'>Редактировать</button> :
                            <button onClick={this.saveChanges} id='saveChngBtn'>Сохранить</button>
                    }
                </td>
                <td>
                    {
                        this.state.mode === 'show' ?
                            <button onClick={this.deleteClient} id='deleteBtn'>Удалить</button> :
                            <button onClick={this.cancelEdit} id='cancelChngBtn'>Отмена</button>
                    }
                </td>
            </tr>
        )
